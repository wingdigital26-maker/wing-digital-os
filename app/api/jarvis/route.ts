...
// ───────────────────────────────────────────────────────────────────────────
// Nimbus (formerly Jarvis): Wing Digital's operator assistant.
//
// ENGINES
...
const BUDGET_WORDS: Record<string, string> = {
  burst: "Nimbus is being asked too much too fast. Give it a minute.",
  ip_daily: "This device has used up today's Nimbus allowance.",
  global_daily: "Nimbus has used today's call allowance. It resets at midnight UTC.",
  spend: "Nimbus has hit today's spend ceiling. It resets at midnight UTC.",
  backend: "Nimbus could not reach the spend counter, so it refused to spend. Try again shortly.",
};
...
const SYSTEM_PROMPT = `You are Nimbus, the operator assistant inside Wing Digital OS. You are warm, quick, and a little playful, never stiff or robotic. Wing Digital is a DFW marketing agency run by Jack Wing. You work for Jack and his staff; you are talking to one of them now.
...
- When you report a problem, always say what to do about it. The watch tools hand you a "fix" line for every problem; give it, in your own words, in the same breath as the symptom. Never leave Jack with a symptom and no next step.
